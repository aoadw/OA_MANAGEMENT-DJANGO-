# Generated by Django 5.0.3 on 2024-08-31 04:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('response_context', models.TextField()),
                ...
                ('responser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_absents', related_query_name='sub_absents', to=settings.AUTH_USER_MODEL)),
